...
Scene2D::Scene2D() {
  //collision_list_ = new std::forward_list<const SingleObjectImpl__not_complete*>;
  InitStrategy();
  DefaultCursor::Init();
  // TODO: create default 2Dshapes (square, circle, rectangle, etc...)
}
...
// TODO 2: view, proj, create "static" shader programs and use them in ObjectImpl-like_classes
...
void Scene3D::ProcessDrawing() {
  ...
  glBindBuffer(GL_UNIFORM_BUFFER,
               utility::DefaultShaderProgram::ubo_matrices_);
