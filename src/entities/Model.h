...
#include "../loader/LoadPathManager.h"
...
// TODO: each animation has all transforation matrices to all
//         bones (for each animation frame)
...
/// IF there is no animations, we not tracking even bones
///   (NO BONES/UBO LOGIC without animations)
