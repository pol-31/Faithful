...
void SimurghManager::Init() {
  ...
  thread_pool_manager_->get_render_thread_pool()->Config([=]() {
    ...
    // Model
    // skeleton("/home/pavlo/Downloads/6e48z1kc7r40-bugatti/bugatti/bugatti.obj");
...
void SimurghManager::StartProcessing() {
  ...
  thread_pool_manager_->get_render_thread_pool()->Config([=]() {
    ...
    // auto model1 = new ModelLoader("/home/pavlo/Downloads/Longbow/Erika
    // Archer.dae", true); auto model6 = new
    // Model("../resources/objects/43-obj/obj/Wolf_One_obj.obj", true); auto
    // model2 = new ModelLoader("../resources/objects/Skeleton.fbx", true);
    ...
    // auto model2 = new Model("../resources/objects/cube_obj/cottage_obj.obj",
    // true); model2->TranslateTo(0.0f, 3.0f, 0.0f);
    //    model2->ScaleTo(0.0001f, 0.0001f, 0.0001f);

    //    auto model1 = new Model("../resources/objects/cube_obj/cottege1.obj",
    //    true); model1->TranslateTo(0.0f, 3.0f, 0.0f);
    // auto model4 = new Model("../resources/objects/backpack/backpack.obj",
    // true); model4->TranslateTo(0.0f, 4.0f, 0.0f); auto model3 = new
    // Model("../resources/objects/cube_obj/ak.obj", true);
