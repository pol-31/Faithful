...
inline void ShaderProgram::AdjustMat2v(
  const GLchar* name,
  GLsizei count,
  GLboolean transpose,
  const GLfloat *value) {
...
inline void ShaderProgram::AdjustMat3v(
  const GLchar* name,
  GLsizei count,
  GLboolean transpose,
  const GLfloat *value) {
...
inline void ShaderProgram::AdjustMat4v(
  const GLchar* name,
  GLsizei count,
  GLboolean transpose,
  const GLfloat *value) {
...
inline void ShaderProgram::AdjustMat2x3v(
  const GLchar* name,
  GLsizei count,
  GLboolean transpose,
  const GLfloat *value) {
...
inline void ShaderProgram::AdjustMat3x2v(
  const GLchar* name,
  GLsizei count,
  GLboolean transpose,
  const GLfloat *value) {
...
inline void ShaderProgram::AdjustMat2x4v(
  const GLchar* name,
  GLsizei count,
  GLboolean transpose,
  const GLfloat *value) {
...
inline void ShaderProgram::AdjustMat4x2v(
  const GLchar* name,
  GLsizei count,
  GLboolean transpose,
  const GLfloat *value) {
...
inline void ShaderProgram::AdjustMat3x4v(
  const GLchar* name,
  GLsizei count,
  GLboolean transpose,
  const GLfloat *value) {
...
inline void ShaderProgram::AdjustMat4x3v(
  const GLchar* name,
  GLsizei count,
  GLboolean transpose,
  const GLfloat *value) {
