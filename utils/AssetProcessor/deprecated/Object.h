...
class Object3D : public Object {
 public:
  ...
  void RotateToRelated(float angle, float x, float y, float z, float origin_x, float origin_y, float origin_z) {}
  void RotateOnRelated(float angle, float x, float y, float z, float origin_x, float origin_y, float origin_z) {}

  void ScaleTo(float x, float y, float z) {}
  void ScaleOn(float x, float y, float z) {
    *transform_ = glm::scale(*transform_, glm::vec3(x, y, z));
  }
  void ScaleToRelated(float x, float y, float z, float origin_x, float origin_y, float origin_z) {}
  void ScaleOnRelated(float x, float y, float z, float origin_x, float origin_y, float origin_z) {}
  ...
  void RotateToRelated(float angle, glm::vec3 rotation, glm::vec3 origin_position) {}
  void RotateOnRelated(float angle, glm::vec3 rotation, glm::vec3 origin_position) {}
...
class SkinnedObject3DImpl : public ObjectImplBase {
 ...
 protected:
  ...
  utility::Span<AnimationNode*> animation_nodes_ = utility::Span<AnimationNode*>();
